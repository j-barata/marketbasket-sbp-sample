...
export default function MushroomOmelette() {
  return (
    <Card>
      <CardActionArea>
        <CardMedia
          ...
          image="https://source.unsplash.com/featured/?mushroom,omelette"
        ...
        <CardContent>
          <Typography gutterBottom variant="h5" component="h2">Mushroom Omelette</Typography>
